...
1. Edite `normalizer.py` para adicionar função de normalização
2. Atualize `pipeline.py` para aplicar a normalização
3. Modifique `validator.py` para adicionar validação

### Suportar Novos Formatos

Edite `loader.py` para incluir novos tipos de arquivo (JSON, Parquet, etc.)
...
- GitHub: [@Joker7657](https://github.com/Joker7657)
- Repositório: [Data-Cleaning-Quality-Control](https://github.com/Joker7657/Data-Cleaning-Quality-Control)

---

## 📞 Suporte

Encontrou um bug ou tem uma sugestão? Abra uma [issue](https://github.com/Joker7657/Data-Cleaning-Quality-Control/issues)!
